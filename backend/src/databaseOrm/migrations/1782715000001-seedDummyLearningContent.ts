...
export class SeedDummyLearningContent1782715000001 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DELETE FROM "Assignment" WHERE id IN ('70000000-0000-0000-0000-000000000010', '70000000-0000-0000-0000-000000000011', '70000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000002');`);
    await queryRunner.query(`DELETE FROM "Lesson" WHERE id IN ('60000000-0000-0000-0000-000000000010', '60000000-0000-0000-0000-000000000011', '60000000-0000-0000-0000-000000000012', '60000000-0000-0000-0000-000000000013', '60000000-0000-0000-0000-000000000014', '60000000-0000-0000-0000-000000000015');`);
    await queryRunner.query(`DELETE FROM "LearningPathModule" WHERE id IN ('50000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000005');`);
    await queryRunner.query(`DELETE FROM "Module" WHERE id IN ('40000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000005');`);
    await queryRunner.query(`DELETE FROM "LearningPath" WHERE id IN ('30000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003');`);
  }
}
