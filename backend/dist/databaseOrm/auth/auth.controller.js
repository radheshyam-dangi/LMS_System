...
const completeSignup_dto_1 = require("./dto/completeSignup.dto");
...
__decorate([
    (0, common_1.Post)('complete-signup') // <--- MUST BE 'complete-signup'
    ,
    __param(0, (0, common_1.Query)('token')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, completeSignup_dto_1.CompleteSignupDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "completeSignup", null);
exports.AuthController = AuthController = __decorate([
    (0, common_1.Controller)('auth') // <--- MUST BE 'auth'
    ,
